...
![banner](https://img.shields.io/badge/version-1.5.0-blue)
...
- **音量控制**:整体音量(菜单)+ 单窗口会话音量(卡片 ♪),可静音、可随定时任务自动调节。
- **定时任务**:一次性 / 间隔 / 每天 / 每周四种频率,十种动作,持久化保存,支持暂停/立即执行。
...
- **设置**:全局热键(F9 启动 / F10 停止 / Ctrl+Alt+P 急停)、卡片尺寸、聚焦铺满、游戏进程(退出关游戏 / 启动唤醒)、音量、Steam 状态联动、截图帧率、深色/浅色主题、开机自启动、检查更新。
...
12. 同时开多个窗口太吵?用「工具 → 整体音量」调总音量,或点卡片 ♪ 调单个游戏的音量。
